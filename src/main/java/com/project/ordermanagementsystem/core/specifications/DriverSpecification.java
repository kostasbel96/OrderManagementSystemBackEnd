...
public class DriverSpecification {
    ...
    // ---------------- GLOBAL SEARCH ----------------
    public static Specification<DriverPerson> globalSearch(String value) {
    ...
    // ---------------- ACTIVE ----------------
    public static Specification<DriverPerson> isActive() {
        return (root, query, cb) -> cb.isTrue(root.get("active"));
    }

    // ---------------- FILTER ENGINE ----------------
    public static Specification<DriverPerson> fromFilter(FilterRequest filter) {
        return (root, query, cb) -> {
