...
public class OrderRestController {
    ...
    public ResponseEntity<Page<OrderReadOnlyDTO>> searchOrders(@RequestBody SearchRequest request){

        Page<OrderReadOnlyDTO> responseDto = orderService.searchOrders(request);
